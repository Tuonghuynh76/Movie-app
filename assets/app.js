const API_KEY = '016abaa7e09129ab99dca6e7776d944b';
const image_path = `https://image.tmdb.org/t/p/w1280`;

const input = document.querySelector('.search input')
const btn = document.querySelector('.search button')
const main_grid_title = document.querySelector('.movies h1')
const main_grid = document.querySelector('.movies .movies-grid')
            ...
            <div class="card" data-id="${e.id}">
                ...
                <div class="info">
                    ...
                    <div class="single-info">
                        <span>Rate: </span>
                        <span>${e.vote_average} <span class="fa fa-star checked"></span></span>
                    </div>
                    <div class="single-info">
            ...
            <div class="content">
                ...
                <div class="right">
                    ...
                    <div class="single-info-container">
                        ...
                        <div class="single-info">
                            <span>Rate:</span>
                            <span>${movie.vote_average} <span class="fa fa-star checked"></span></span>
                        </div>
                        <div class="single-info">
                            <span>Budget:</span>
...
async function add_to_dom_trending () {
    ...
    trending_el.innerHTML = data.slice(0, 13).map(e => {
        return `
            <div class="card" data-id="${e.id}">
                <div class="img">
                    <img src="${image_path + e.poster_path}">
